...
// Texto: Almeida Corrigida Fiel (ACF), conferido no serviço oficial da SBTB em 09/09/2026.
// Fonte e revisão individual: docs/revisao-acf-2026-09-09.md.
// © 1994, 1995, 2007, 2011 Sociedade Bíblica Trinitariana do Brasil / Trinitarian Bible Society.

/** @typedef {{id:string, ref:string, text:string, themes:string[], context?:string}} Verse */
...
export const VERSES = [
  ...
  { id: "rm10-9", ref: "Romanos 10:9", themes: ["salvação", "fé"], text: "A saber: Se com a tua boca confessares ao Senhor Jesus, e em teu coração creres que Deus o ressuscitou dentre os mortos, serás salvo." },
  ...
  { id: "ef2-8", ref: "Efésios 2:8", themes: ["graça", "fé", "salvação"], text: "Porque pela graça sois salvos, por meio da fé; e isto não vem de vós, é dom de Deus.", context: "Efésios 2:8-10 apresenta a salvação pela graça e as boas obras como resultado dela." },
  { id: "ef2-9", ref: "Efésios 2:9", themes: ["graça", "salvação"], text: "Não vem das obras, para que ninguém se glorie;", context: "Este versículo continua Efésios 2:8. Leia 2:8-10 para não separar a graça das boas obras que a seguem." },
  { id: "tt3-5", ref: "Tito 3:5", themes: ["graça", "salvação", "nova vida"], text: "Não pelas obras de justiça que houvéssemos feito, mas segundo a sua misericórdia, nos salvou pela lavagem da regeneração e da renovação do Espírito Santo,", context: "Tito 3:3-7 contrasta a antiga vida com a salvação pela misericórdia de Deus." },
  { id: "2tm1-9", ref: "2 Timóteo 1:9", themes: ["graça", "salvação"], text: "Que nos salvou, e chamou com uma santa vocação; não segundo as nossas obras, mas segundo o seu próprio propósito e graça que nos foi dada em Cristo Jesus antes dos tempos dos séculos;", context: "Paulo fala da graça e do chamado de Deus em 2 Timóteo 1:8-10." },
  { id: "ap3-20", ref: "Apocalipse 3:20", themes: ["convite"], text: "Eis que estou à porta, e bato; se alguém ouvir a minha voz, e abrir a porta, entrarei até ele, e com ele cearei, e ele comigo.", context: "Jesus se dirige à igreja de Laodiceia. Leia Apocalipse 3:14-22; a imagem da porta integra esse chamado ao arrependimento." },
  ...
  { id: "jo1-12", ref: "João 1:12", themes: ["salvação", "fé", "nova vida"], text: "Mas, a todos quantos o receberam, deu-lhes o poder de serem feitos filhos de Deus, aos que creem no seu nome;" },
  { id: "is1-18", ref: "Isaías 1:18", themes: ["perdão", "convite", "pecado"], text: "Vinde então, e raciocinemos juntos, diz o Senhor: ainda que os vossos pecados sejam como a escarlata, eles se tornarão brancos como a neve; ainda que sejam vermelhos como o carmesim, se tornarão como a branca lã." },
  ...
  { id: "rm3-10", ref: "Romanos 3:10", themes: ["pecado"], text: "Como está escrito: Não há um justo, nem um sequer." },
  ...
  { id: "at3-19", ref: "Atos 3:19", themes: ["arrependimento", "perdão"], text: "Arrependei-vos, pois, e convertei-vos, para que sejam apagados os vossos pecados, e para que venham assim os tempos do refrigério pela presença do Senhor," },
  ...
  { id: "sl103-12", ref: "Salmos 103:12", themes: ["perdão"], text: "Assim como está longe o oriente do ocidente, assim afasta de nós as nossas transgressões." },
  ...
  { id: "1jo4-19", ref: "1 João 4:19", themes: ["amor"], text: "Nós o amamos porque ele nos amou primeiro." },
  { id: "jr31-3", ref: "Jeremias 31:3", themes: ["amor"], text: "Há muito que o Senhor me apareceu, dizendo: Porquanto com amor eterno te amei, por isso com benignidade te atraí.", context: "Jeremias anuncia a restauração de Israel em 31:1-6." },
  { id: "ef2-4", ref: "Efésios 2:4-5", themes: ["amor", "graça"], text: "Mas Deus, que é riquíssimo em misericórdia, pelo seu muito amor com que nos amou, Estando nós ainda mortos em nossas ofensas, nos vivificou juntamente com Cristo (pela graça sois salvos)," },
  { id: "jo15-13", ref: "João 15:13", themes: ["amor"], text: "Ninguém tem maior amor do que este, de dar alguém a sua vida pelos seus amigos." },
  { id: "rm8-38", ref: "Romanos 8:38-39", themes: ["amor", "esperança"], text: "Porque estou certo de que, nem a morte, nem a vida, nem os anjos, nem os principados, nem as potestades, nem o presente, nem o porvir, Nem a altura, nem a profundidade, nem alguma outra criatura nos poderá separar do amor de Deus, que está em Cristo Jesus nosso Senhor." },
  { id: "rm8-39", ref: "Romanos 8:39", themes: ["amor", "esperança"], text: "Nem a altura, nem a profundidade, nem alguma outra criatura nos poderá separar do amor de Deus, que está em Cristo Jesus nosso Senhor.", context: "Continuação de Romanos 8:38. Para uma mensagem completa no cartão, prefira o trecho 8:38-39 disponível no painel." },
  ...
  { id: "1jo5-13", ref: "1 João 5:13", themes: ["vida eterna", "fé", "esperança"], text: "Estas coisas vos escrevi, os que credes no nome do Filho de Deus, para que saibais que tendes a vida eterna, e para que creiais no nome do Filho de Deus." },
  ...
  { id: "gl2-20", ref: "Gálatas 2:20", themes: ["nova vida", "fé"], text: "Já estou crucificado com Cristo; e vivo, não mais eu, mas Cristo vive em mim; e a vida que agora vivo na carne, vivo-a pela fé do Filho de Deus, o qual me amou, e se entregou a si mesmo por mim." },
  { id: "rm12-2", ref: "Romanos 12:2", themes: ["nova vida"], text: "E não sejais conformados com este mundo, mas sede transformados pela renovação do vosso entendimento, para que experimenteis qual seja a boa, agradável, e perfeita vontade de Deus." },
  ...
  { id: "fp4-6", ref: "Filipenses 4:6", themes: ["paz", "consolo"], text: "Não estejais inquietos por coisa alguma; antes as vossas petições sejam em tudo conhecidas diante de Deus pela oração e súplica, com ação de graças." },
  { id: "fp4-7", ref: "Filipenses 4:7", themes: ["paz", "consolo"], text: "E a paz de Deus, que excede todo o entendimento, guardará os vossos corações e os vossos pensamentos em Cristo Jesus." },
  { id: "fp4-13", ref: "Filipenses 4:13", themes: ["esperança", "fé"], text: "Posso todas as coisas em Cristo que me fortalece.", context: "Em Filipenses 4:10-13, Paulo fala de contentamento tanto na abundância quanto na necessidade; não de sucesso garantido em qualquer objetivo." },
  ...
  { id: "rm8-28", ref: "Romanos 8:28", themes: ["esperança", "consolo"], text: "E sabemos que todas as coisas contribuem juntamente para o bem daqueles que amam a Deus, daqueles que são chamados segundo o seu propósito.", context: "A promessa é dirigida aos que amam a Deus; Romanos 8:29 liga seu propósito à semelhança com Cristo." },
  ...
  { id: "mt6-33", ref: "Mateus 6:33", themes: ["esperança", "fé"], text: "Mas, buscai primeiro o reino de Deus, e a sua justiça, e todas estas coisas vos serão acrescentadas.", context: "Mateus 6:25-34 trata das necessidades diárias e da confiança em Deus, não de uma promessa de riqueza." },
  { id: "is41-10", ref: "Isaías 41:10", themes: ["consolo", "esperança", "paz"], text: "Não temas, porque eu sou contigo; não te assombres, porque eu sou teu Deus; eu te fortaleço, e te ajudo, e te sustento com a destra da minha justiça.", context: "A palavra se dirige a Israel, chamado servo de Deus em Isaías 41:8-10." },
  ...
  { id: "mt28-20", ref: "Mateus 28:20", themes: ["consolo", "esperança"], text: "Ensinando-os a guardar todas as coisas que eu vos tenho mandado; e eis que eu estou convosco todos os dias, até a consumação do mundo. Amém.", context: "A promessa acompanha a missão de fazer discípulos e ensinar o que Jesus ordenou em Mateus 28:18-20." },
  ...
  { id: "1pe2-24", ref: "1 Pedro 2:24", themes: ["salvação", "pecado", "perdão"], text: "Levando ele mesmo em seu corpo os nossos pecados sobre o madeiro, para que, mortos para os pecados, pudéssemos viver para a justiça; e pelas suas feridas fostes sarados.", context: "Pedro relaciona a cruz ao abandono do pecado e à vida justa em 1 Pedro 2:21-25." },
  ...
  // ——— Coragem / Confiança ———
  { id: "js1-9", ref: "Josué 1:9", themes: ["coragem", "consolo"], text: "Não to mandei eu? Esforça-te, e tem bom ânimo; não temas, nem te espantes; porque o Senhor teu Deus é contigo, por onde quer que andares.", context: "Deus encoraja Josué na missão que lhe confiou; leia Josué 1:1-9." },
  { id: "dt31-6", ref: "Deuteronômio 31:6", themes: ["coragem", "consolo"], text: "Esforçai-vos, e animai-vos; não temais, nem vos espanteis diante deles; porque o Senhor teu Deus é o que vai contigo; não te deixará nem te desamparará.", context: "Moisés encoraja Israel antes da entrada na terra prometida. Leia Deuteronômio 31:1-8." },
  ...
  { id: "is40-31", ref: "Isaías 40:31", themes: ["esperança", "coragem"], text: "Mas os que esperam no Senhor renovarão as forças, subirão com asas como águias; correrão, e não se cansarão; caminharão, e não se fatigarão." },
  ...
  { id: "sl91-1", ref: "Salmos 91:1", themes: ["consolo", "paz"], text: "Aquele que habita no esconderijo do Altíssimo, à sombra do Onipotente descansará.", context: "O salmo expressa confiança e refúgio em Deus; não deve ser usado como autorização para se expor ao perigo." },
  ...
  { id: "sl121-1", ref: "Salmos 121:1-2", themes: ["consolo", "esperança"], text: "Levantarei os meus olhos para os montes, de onde vem o meu socorro. O meu socorro vem do Senhor que fez o céu e a terra." },
  { id: "na1-7", ref: "Naum 1:7", themes: ["consolo", "esperança"], text: "O Senhor é bom, ele serve de fortaleza no dia da angústia, e conhece os que confiam nele." },
  ...
  { id: "is43-1", ref: "Isaías 43:1", themes: ["consolo", "amor"], text: "Mas agora, assim diz o Senhor que te criou, ó Jacó, e que te formou, ó Israel: Não temas, porque eu te remi; chamei-te pelo teu nome, tu és meu.", context: "O texto nomeia Jacó e Israel como destinatários. Leia Isaías 43:1-7 para compreender a promessa." },
  ...
  { id: "jo8-32", ref: "João 8:32", themes: ["verdade"], text: "E conhecereis a verdade, e a verdade vos libertará.", context: "A promessa está ligada a permanecer na palavra de Jesus e ser seu discípulo em João 8:31-36." },
  ...
  { id: "gl5-22", ref: "Gálatas 5:22", themes: ["nova vida", "alegria"], text: "Mas o fruto do Espírito é: amor, gozo, paz, longanimidade, benignidade, bondade, fé, mansidão, temperança.", context: "Leia Gálatas 5:16-25: o fruto descreve a vida guiada pelo Espírito." },
  ...
  // ——— Evangelização / Reconciliação / Comunhão (revisão 09/09/2026) ———
  { id: "lc19-10", ref: "Lucas 19:10", themes: ["salvação", "convite"], text: "Porque o Filho do homem veio buscar e salvar o que se havia perdido." },
  { id: "mc2-17", ref: "Marcos 2:17", themes: ["arrependimento", "convite"], text: "E Jesus, tendo ouvido isto, disse-lhes: Os sãos não necessitam de médico, mas, sim, os que estão doentes; eu não vim chamar os justos, mas, sim, os pecadores ao arrependimento." },
  { id: "jo1-29", ref: "João 1:29", themes: ["salvação", "perdão"], text: "No dia seguinte João viu a Jesus, que vinha para ele, e disse: Eis o Cordeiro de Deus, que tira o pecado do mundo." },
  { id: "jo3-18", ref: "João 3:18", themes: ["salvação", "fé"], text: "Quem crê nele não é condenado; mas quem não crê já está condenado, porquanto não crê no nome do unigênito Filho de Deus." },
  { id: "jo6-40", ref: "João 6:40", themes: ["vida eterna", "fé"], text: "Porquanto a vontade daquele que me enviou é esta: Que todo aquele que vê o Filho, e crê nele, tenha a vida eterna; e eu o ressuscitarei no último dia." },
  { id: "jo6-47", ref: "João 6:47", themes: ["vida eterna", "fé"], text: "Na verdade, na verdade vos digo que aquele que crê em mim tem a vida eterna." },
  { id: "at10-43", ref: "Atos 10:43", themes: ["perdão", "fé"], text: "A este dão testemunho todos os profetas, de que todos os que nele creem receberão o perdão dos pecados pelo seu nome." },
  { id: "at17-30", ref: "Atos 17:30", themes: ["arrependimento", "convite"], text: "Mas Deus, não tendo em conta os tempos da ignorância, ordena agora a todos os homens, e em todo o lugar, que se arrependam;" },
  { id: "rm5-6", ref: "Romanos 5:6", themes: ["amor", "salvação"], text: "Porque Cristo, estando nós ainda fracos, morreu a seu tempo pelos ímpios." },
  { id: "rm10-17", ref: "Romanos 10:17", themes: ["fé", "verdade"], text: "De sorte que a fé é pelo ouvir, e o ouvir pela palavra de Deus." },
  { id: "2co5-19", ref: "2 Coríntios 5:19", themes: ["perdão", "salvação"], text: "Isto é, Deus estava em Cristo reconciliando consigo o mundo, não lhes imputando os seus pecados; e pôs em nós a palavra da reconciliação." },
  { id: "2co5-20", ref: "2 Coríntios 5:20", themes: ["convite", "salvação"], text: "De sorte que somos embaixadores da parte de Cristo, como se Deus por nós rogasse. Rogamo-vos, pois, da parte de Cristo, que vos reconcilieis com Deus." },
  { id: "1tm2-5", ref: "1 Timóteo 2:5-6", themes: ["salvação", "graça"], text: "Porque há um só Deus, e um só Mediador entre Deus e os homens, Jesus Cristo homem. O qual se deu a si mesmo em preço de redenção por todos, para servir de testemunho a seu tempo." },
  { id: "hb7-25", ref: "Hebreus 7:25", themes: ["salvação", "esperança"], text: "Portanto, pode também salvar perfeitamente os que por ele se chegam a Deus, vivendo sempre para interceder por eles." },
  { id: "1pe3-18", ref: "1 Pedro 3:18", themes: ["salvação", "perdão"], text: "Porque também Cristo padeceu uma vez pelos pecados, o justo pelos injustos, para levar-nos a Deus; mortificado, na verdade, na carne, mas vivificado pelo Espírito;" },
  { id: "is55-1", ref: "Isaías 55:1", themes: ["convite", "graça"], text: "Ó vós, todos os que tendes sede, vinde às águas, e os que não tendes dinheiro, vinde, comprai, e comei; sim, vinde, comprai, sem dinheiro e sem preço, vinho e leite." },
  { id: "hb10-24", ref: "Hebreus 10:24-25", themes: ["amor", "convite"], text: "E consideremo-nos uns aos outros, para nos estimularmos ao amor e às boas obras, Não deixando nossa mútua congregação, como é costume de alguns, antes admoestando-nos uns aos outros; e tanto mais, quanto vedes que se vai aproximando aquele dia.", context: "Hebreus 10:19-25 encoraja os cristãos à comunhão, ao amor e ao cuidado mútuo." },
];
